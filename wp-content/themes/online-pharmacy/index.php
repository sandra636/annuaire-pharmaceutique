...
<div class="box-image-page">
  	<div class="single-page-img"></div>
  	 <div class="box-text">
    	<h2>
		    <?php 
		    $online_pharmacy_blog_title = get_theme_mod('online_pharmacy_edit_blog_page_title', __('Home', 'online-pharmacy')); 
		    echo esc_html($online_pharmacy_blog_title); 
		    ?>
		</h2>
		<?php 
		$online_pharmacy_edit_blog_page_description = get_theme_mod('online_pharmacy_edit_blog_page_description', '');

		if (!empty($online_pharmacy_edit_blog_page_description)) : ?>
		    <p class="blog-description"><?php echo esc_html($online_pharmacy_edit_blog_page_description); ?></p>
		<?php endif; ?>
    </div> 
</div>

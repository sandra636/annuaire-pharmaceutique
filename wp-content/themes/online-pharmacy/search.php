	...
	<main id="tp_content" role="main">
		<div id="primary" class="content-area">
			<div class="page-header">
				...
				<?php else : ?>
					<h1 class="page-title"><?php echo esc_html(get_theme_mod('online_pharmacy_edit_no_result_title',__('Nothing Found','online-pharmacy')));?></h1>
				<?php endif; ?>
			</div>		
			<?php
		          	...
		          	<div class="col-lg-8 col-md-8">
			            ...
			            <?php if ( have_posts() ) :
							...
							endwhile; // End of the loop.
								...
								<p><?php echo esc_html(get_theme_mod('online_pharmacy_edit_no_result_text',__('Sorry, but nothing matched your search terms. Please try again with some different keywords.','online-pharmacy')));?></p>
								<?php
									get_search_form();

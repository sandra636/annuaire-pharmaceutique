...
$online_pharmacy_sticky = get_theme_mod('online_pharmacy_sticky');
    $online_pharmacy_data_sticky = "false";
    if ($online_pharmacy_sticky) {
    $online_pharmacy_data_sticky = "true";
    }
    global $wp_customize;
?>

<div class="headerbox <?php if( is_user_logged_in() && !isset( $wp_customize ) ){ echo "login-user";} ?>" data-sticky="<?php echo esc_attr($online_pharmacy_data_sticky); ?>">
  <div class="container">
    <div class="row">

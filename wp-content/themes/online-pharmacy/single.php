	            ...
	            <?php if ( has_post_thumbnail() ) : ?>
	                ...
	                <div class="featured-image" 
	                     style="background-image: url('<?php echo esc_url( get_the_post_thumbnail_url( get_the_ID(), 'full' ) ); ?>'); 
	                            ...
	                            background-position: <?php echo esc_attr( get_theme_mod( 'online_pharmacy_header_background_position', 'center' ) ); ?>;
	                            background-attachment: <?php echo (get_theme_mod( 'online_pharmacy_header_background_attachment', 1 ) ? 'fixed' : 'scroll'); ?>;
	                            height: <?php echo esc_attr( get_theme_mod( 'online_pharmacy_header_image_height', 350 ) ); ?>px;">
	                </div>
	            <?php else : ?>
